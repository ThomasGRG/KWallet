...
import jp.ikigai.kwallet.ui.viewmodels.details.CounterPartyDetailsScreenState
...
@Composable
fun CounterPartyDetailsScreen(
    navigateBack: () -> Unit,
    editCounterParty: () -> Unit,
    deleteCounterParty: () -> Unit,
    setCurrency: (String) -> Unit,
    setYearMonth: (YearMonth) -> Unit,
    screenState: CounterPartyDetailsScreenState
) {
    ...
    Scaffold(
        ...
        topBar = {
            DetailsScreenTopAppBar(
                title = screenState.counterParty.name,
                iconName = screenState.counterParty.iconName,
        ...
        bottomBar = {
            Column {
                ...
                DetailsScreenRoundedBottomBar(
                    editClick = editCounterParty,
                    editIconDescription = "edit counterParty",
                    deleteClick = deleteCounterParty,
                    deleteIconDescription = "delete counterParty",
...
@Preview
@Composable
fun CounterPartyDetailsScreenPreview() {
    CounterPartyDetailsScreen(
        navigateBack = {},
        editCounterParty = {},
        deleteCounterParty = {},
        setCurrency = {},
...
fun NavGraphBuilder.addCounterPartyDetailsScreen(navController: NavController) {
    composable(
        route = Routes.CounterPartyDetails.route,
        arguments = listOf(
            navArgument("id") {
                defaultValue = -1L
        ...
        val viewModel: CounterPartyDetailsViewModel = koinViewModel()
        ...
        CounterPartyDetailsScreen(
            ...
            editCounterParty = {
                navController.navigate(Routes.UpsertCounterParty.getRoute(viewModel.counterPartyId)) {
