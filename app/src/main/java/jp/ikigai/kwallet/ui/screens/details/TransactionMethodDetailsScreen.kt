...
import jp.ikigai.kwallet.ui.viewmodels.details.TransactionMethodDetailsScreenState
...
@Composable
fun TransactionMethodDetailsScreen(
    navigateBack: () -> Unit,
    editTransactionMethod: () -> Unit,
    deleteTransactionMethod: () -> Unit,
    setCurrency: (String) -> Unit,
    setYearMonth: (YearMonth) -> Unit,
    screenState: TransactionMethodDetailsScreenState
) {
    ...
    Scaffold(
        ...
        topBar = {
            DetailsScreenTopAppBar(
                title = screenState.transactionMethod.method,
                iconName = screenState.transactionMethod.iconName,
                type = Type.METHOD
            )
        },
        bottomBar = {
            Column {
                ...
                DetailsScreenRoundedBottomBar(
                    editClick = editTransactionMethod,
                    editIconDescription = "edit transaction method",
                    deleteClick = deleteTransactionMethod,
                    deleteIconDescription = "delete transaction method",
            ...
            Column(
                ...
                if (screenState.transactions.isEmpty()) {
                    ...
                    Row(
                        ...
                        Text(text = stringResource(id = R.string.empty_transactions_label))
                    }
                }
            }
        }
...
@Preview
@Composable
fun TransactionMethodDetailsScreenPreview() {
    TransactionMethodDetailsScreen(
        navigateBack = {},
...
fun NavGraphBuilder.addTransactionMethodDetailsScreen(navController: NavController) {
    composable(
        route = Routes.TransactionMethodDetails.route,
        arguments = listOf(
            navArgument("id") {
                defaultValue = -1L
        ...
        val viewModel: TransactionMethodDetailsViewModel = koinViewModel()
        ...
        TransactionMethodDetailsScreen(
            ...
            editTransactionMethod = {
                navController.navigate(Routes.UpsertTransactionMethod.getRoute(viewModel.transactionMethodId)) {
