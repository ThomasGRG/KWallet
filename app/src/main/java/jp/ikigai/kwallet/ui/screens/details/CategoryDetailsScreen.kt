...
import jp.ikigai.kwallet.data.Constants.tweenDuration
...
import jp.ikigai.kwallet.ui.viewmodels.details.CategoryDetailsScreenState
...
fun CategoryDetailsScreen(
    ...
    screenState: CategoryDetailsScreenState
) {
    ...
    Scaffold(
        ...
        topBar = {
            DetailsScreenTopAppBar(
                title = screenState.category.name,
                iconName = screenState.category.iconName,
                type = Type.CATEGORY
            )
        },
        bottomBar = {
            Column {
                ...
                DetailsScreenRoundedBottomBar(
                    ...
                    editIconDescription = "edit category",
                    deleteClick = deleteCategory,
                    deleteIconDescription = "delete category",
...
fun NavGraphBuilder.addCategoryDetailsScreen(navController: NavController) {
    composable(
        route = Routes.CategoryDetails.route,
        arguments = listOf(
            navArgument("id") {
                defaultValue = -1L
        ...
        CategoryDetailsScreen(
            ...
            editCategory = {
                navController.navigate(Routes.UpsertCategory.getRoute(viewModel.categoryId)) {
